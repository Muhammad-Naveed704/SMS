    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        className={cn(
          ...
          side === "left" &&
            "inset-y-0 left-0 h-full w-64 border-r data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left",
          side === "right" &&
